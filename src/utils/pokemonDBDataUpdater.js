...
import { APIS } from '../config/constants.js';
...
export const directExecutionLogic = async () => {
  try {
...
// Checks if the file is ran directly rather than being imported
let entryFile = process.argv?.[1];

if (entryFile === __filename) {
  directExecutionLogic();
}
